...
<nav class="main-nav-outer" id="test"><!--main-nav-start-->
	<div class="container">
        <ul class="main-nav">
            ...
            <li><a href="#testimonial">Nghiên Cứu</a></li>
	...
	<div class="container">
        ...
        <div class="row">
            ...
            <figure class="col-lg-8 col-sm-6  text-right wow fadeInUp delay-02s">
            	<img src="img/large_logo.jpg" alt="">
            </figure>
...
<section class="main-section paddind" id="Portfolio"><!--main-section-start-->
	<div class="container">
    	...
    	<h6>Chúng tôi hướng tới sự chuyên nghiệp cùng với những trải nghiệm khác biệt trong mỗi sản phẩm và dịch vụ mà MACRGROUP cung cấp cho cộng đồng. <br /> Tất cả cùng cố gắng vì tương lai dân tộc Việt Nam trên con đường hướng tới sự thịnh vượng chung.</h6>
      <div class="portfolioFilter">  
        <ul class="Portfolio-nav wow fadeIn delay-02s">
            <li><a href="#" data-filter=".branding" class="current">MACR</a></li>
            <li><a href="#" data-filter=".printdesign" >SNOWBALL</a></li>
            <li><a href="#" data-filter=".webdesign" >KD AGRICO</a></li>
            <li><a href="#" data-filter=".printdesign" >DU LỊCH VĂN HOÁ</a></li>
            <li><a href="#" data-filter=".photography" >CỘNG ĐỒNG</a></li></a></li>
        </ul>
       </div> 
 ...
 <!-- =========================
    ...
    <section id="testimonial" class="testimonial padding-large white-color text-center">
        <div class="container">
            <div class="row">
                <h2 class="what-customer-said-h2">What Our Customer Said</h2>
